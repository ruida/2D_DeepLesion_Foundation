...
IMAGES_DIR="/data/ruida/segmentation/Swin-UMamba-Origin/dataset719_yolo_test/images"
YOLO_LABELS_DIR="/data/ruida/segmentation/Swin-UMamba-Origin/dataset719_yolo_test/yolotlpmoe_predictions/labels"

ROI_ROOT="/data/ruida/segmentation/Swin-UMamba-Origin/dataset719_roi_outputs_top1_foldall"
...
nnUNetv2_predict   -d "${DATASET_ID}"   -c "${CONFIG}"   -f "${FOLD}"   -i "${ROI_IMAGES_TS}"   -o "${ROI_PREDS}"   -tr "${TRAINER}" -npp 1 -nps 1
