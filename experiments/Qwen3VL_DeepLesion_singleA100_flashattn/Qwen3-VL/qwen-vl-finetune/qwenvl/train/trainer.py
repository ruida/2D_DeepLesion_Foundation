...
def flash_attention_forward(
    ...
    **kwargs,
    ...
    if flash_attn_varlen_func is None:
        raise RuntimeError("flash_attn_varlen_func is unavailable; flash attention path should not be used.")
...
def replace_qwen2_vl_attention_class():
    if not FLASH_ATTN_AVAILABLE:
        print("flash_attn not available; keeping default attention implementation.")
        return
    import transformers
