...
ANN=data/simple_pair_rag_annotations/08_report_metadata_gated_rag_test_r2gen_ready.json
SAVE_DIR=results/report_metadata_gated_rag_r2gen_test
LOG=logs/simple_pair_rag/test_report_metadata_gated_rag.log
