...
ANN=data/simple_pair_rag_annotations/07_trainval_joint_rag_test_r2gen_ready.json
SAVE_DIR=results/trainval_joint_rag_r2gen_test
LOG=logs/simple_pair_rag/test_trainval_joint_rag.log
