...
PRED_DIR = Path("/data/ruida/segmentation/Swin-UMamba-Origin/results/Dataset719_DeepLesion2D/pred_2d")
OUT_CSV = Path("/data/ruida/segmentation/Swin-UMamba-Origin/results/Dataset719_DeepLesion2D/pred_2d_ken_metrics.csv")
...
for gt_path in gt_paths:
    ...
    rows.append({
        ...
        "hausdorff95": hd95_score(gt, pred),
