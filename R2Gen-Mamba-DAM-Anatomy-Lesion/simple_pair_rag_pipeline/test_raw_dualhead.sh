...
ANN=data/simple_pair_rag_annotations/06b_raw_dualhead_r2gen_ready.json
CKPT=results/oracle_simple_r2gen/model_best.pth
SAVE_DIR=results/raw_dualhead_r2gen_test
LOG=logs/simple_pair_rag/test_raw_dualhead.log
