...
ROI_ROOT="/data/ruida/segmentation/Swin-UMamba/roi_outputs"
...
nnUNetv2_predict   -d "${DATASET_ID}"   -c "${CONFIG}"   -f "${FOLD}"   -i "${ROI_IMAGES_TS}"   -o "${ROI_PREDS}"   -tr "${TRAINER}"
