...
SAVE_DIR=results/step1_improved_oracle_report_anatomy_text
ANN=data/generated_annotations/original_report_anat_lesion_token_improved_v2/deeplesion_original_report_anat_lesion_token_all_improved_v2.json
