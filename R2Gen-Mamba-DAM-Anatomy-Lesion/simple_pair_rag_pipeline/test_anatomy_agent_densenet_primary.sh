...
ANN=data/simple_pair_rag_annotations/13_anatomy_agent_densenet_primary_test_r2gen_ready.json
CKPT=results/oracle_simple_r2gen/model_best.pth
SAVE_DIR=results/anatomy_agent_densenet_primary_test
LOG=logs/simple_pair_rag/test_anatomy_agent_densenet_primary.log

mkdir -p "$SAVE_DIR"
mkdir -p logs/simple_pair_rag
