...
ANN=data/simple_pair_rag_annotations/05b_anatomy_only_rag_r2gen_ready.json
CKPT=results/oracle_simple_r2gen/model_best.pth
SAVE_DIR=results/anatomy_only_rag_r2gen_test
LOG=logs/simple_pair_rag/test_anatomy_only_rag.log
