...
ANN=data/simple_pair_rag_annotations/05_simple_pair_rag_r2gen_ready.json
CKPT=results/oracle_simple_r2gen/model_best.pth
SAVE_DIR=results/simple_pair_rag_r2gen_test
LOG=logs/simple_pair_rag/test_simple_pair_rag.log
