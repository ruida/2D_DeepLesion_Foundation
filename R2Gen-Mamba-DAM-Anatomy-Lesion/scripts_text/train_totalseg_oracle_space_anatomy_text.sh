...
SAVE_DIR=results/step1_gtbbox_totalseg_oracle_space_anatomy_text
ANN=data/generated_annotations/anatomy_text/deeplesion_totalseg_oracle_space_anatomy_text.json
