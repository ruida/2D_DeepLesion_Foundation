...
ANN=data/simple_pair_rag_annotations/10_anatomy_only_agent_rag_test_r2gen_ready.json
SAVE_DIR=results/anatomy_only_agent_rag_r2gen_test
LOG=logs/simple_pair_rag/test_anatomy_only_agent_rag.log
